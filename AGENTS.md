...
- **Exactly ONE commit per task/session — never several.** Even when a
  brief or plan lists steps or suggests a commit sequence, collapse
  everything into a single commit. If more work lands on a task that is
